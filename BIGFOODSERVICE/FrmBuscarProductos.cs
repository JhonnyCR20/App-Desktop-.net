    ...
    public partial class FrmBuscarProductos : Form
    {
        ...
        private void MostrarRegistrarProductos(int funcion)
        {
            ...
            if (funcion == 1 && this.dtgDatos.SelectedRows.Count > 0)
            {
                ...
                temp.Descuento = Convert.ToDouble(this.dtgDatos.SelectedRows[0].Cells["Descuento"].Value);
                temp.Impuesto = Convert.ToDouble(this.dtgDatos.SelectedRows[0].Cells["Impuesto"].Value);
                ...
                temp.PrecioCompra = Convert.ToDouble(this.dtgDatos.SelectedRows[0].Cells["PrecioCompra"].Value);
